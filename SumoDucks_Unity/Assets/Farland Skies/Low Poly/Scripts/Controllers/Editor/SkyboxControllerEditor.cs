...
namespace Borodar.FarlandSkies.LowPoly
{
    ...
    {
        private const string ICONS_FOLDER = "Farland Skies/!Core/Icons/";
        ...
        protected void OnEnable()
        {
            ...
            // Presets
            _presets = EditorGUIUtility.Load("Farland Skies/Low Poly/SkyboxControllerPresets.asset") as SkyboxControllerPresets;
            ...
            var starsTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Star_16.png") as Texture2D;
            var skyTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Sky_16.png") as Texture2D;
            var sunTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Sun_16.png") as Texture2D;
            var moonTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Moon_16.png") as Texture2D;
            var cloudsTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Cloud_16.png") as Texture2D;
            var generalTex = EditorGUIUtility.Load(ICONS_FOLDER + skinFolder + "Tag_16.png") as Texture2D;
